...
out, err = subprocess.Popen(['/usr/bin/tclsh', '/usr/lib/env-modules/modulecmd.tcl', 'python', 'autoinit'], stdout=subprocess.PIPE, stderr=subprocess.PIPE, env=_mlre).communicate()
