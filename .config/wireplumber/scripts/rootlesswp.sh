#!/usr/bin/env bash
# PipeWire + WirePlumber Source Build Script
# Builds latest git versions to XDG_DATA_HOME directories
# Author: Generated for Amor Fati Labs
# Date: 2026-02-02
...
build_wireplumber() {
    ...
    # Set PKG_CONFIG_PATH to find our custom PipeWire
...
generate_env_script() {
    ...
    cat > "$env_script" << 'EOF'
#!/usr/bin/env bash
# PipeWire + WirePlumber Environment Setup
