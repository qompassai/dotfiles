...
---@param si_om WPObjectManager
---@param devices_om WPObjectManager
---@param def_node_type string
---@param port_direction string
---@param media_classes string[]
function pushSelectDefaultNodeEvent(source, si_om, devices_om, def_node_type, port_direction, media_classes)
    local nodes = collectAvailableNodes(si_om, devices_om, port_direction, media_classes)
