...
set -gx GIT_PROTOCOL_VERSION            2
set -gx GIT_SIGNINGKEY (pass show git/signk | string trim)
...
set -gx JJ_USER_NAME                    $GIT_AUTHOR_NAME
set -gx JJ_USER_EMAIL                   $GIT_AUTHOR_EMAIL
