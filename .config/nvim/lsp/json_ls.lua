...
---------------------------------------------------------------------
---@source https://github.com/SchemaStore/schemastore/blob/master/src/api/json/catalog.json
    ...
    json = {
      ...
      schemas = {
        ...
        },
        {
          ...
          fileMatch = { 'manifest.json', 'manifest.jsonc' },
        ...
        },
        {
          ...
          fileMatch = { 'CVE-*.json' },
          url =
          'https://raw.githubusercontent.com/CVEProject/cve-schema/master/schema/docs/CVE_Record_Format_bundled.json',
        },
        {
        ...
        },
        {
          ...
          url =
          '"https://raw.githubusercontent.com/google-gemini/gemini-cli/refs/heads/main/schemas/settings.schema.json',
        },
        {
        ...
        {
          description = 'Poetry',
          fileMatch = { 'pyproject.poetry.json' },
