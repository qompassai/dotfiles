...
function M.rust_cfg(opts)
	...
	M.rust_dap()
	M.rust_crates()
	vim.api.nvim_create_user_command("RustEdition", function(o) U.rust_edition(o.args) end, {
		nargs = 1,
		complete = function() return vim.tbl_keys(U.rust_editions) end,
	})
	vim.api.nvim_create_user_command("RustToolchain", function(o) U.rust_set_toolchain(o.args) end, {
		nargs = 1,
		complete = function() return vim.tbl_keys(U.rust_toolchains) end,
	})
