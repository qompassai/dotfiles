...
function M.setup_navmap()
    ...
    map("n", "<leader>ooh", ":Oil ~/ <CR>",
        vim.tbl_extend("force", opts, {desc = "[o]il [o]pen in [h]ome Directory"}))
    ...
    map("n", "<leader>EI", ":TSNodeIncremental<CR>", vim.tbl_extend("force",
                                                                    opts, {
    ...
    map("n", "<leader>IS", ":TSNodeDecremental<CR>", vim.tbl_extend("force",
                                                                    opts, {
    ...
    map("n", "<leader>ss", ":TSScopeIncremental<CR>",
        vim.tbl_extend("force", opts,
    ...
    map("n", "<leader>tn", ":TSGotoNextFunction<CR>", vim.tbl_extend("force",
                                                                     opts, {
    ...
    map("n", "<leader>tp", ":TSGotoPreviousFunction<CR>", vim.tbl_extend(
    ...
    map("n", "<leader>ts", ":TSToggleHighlight<CR>",
    ...
    map("n", "<leader>sn", ":TSSwapNextParameter<CR>",
    ...
    map("n", "<leader>sp", ":TSSwapPreviousParameter<CR>", vim.tbl_extend(
    ...
    map("n", "<leader>cf", ":TSToggleFold<CR>",
