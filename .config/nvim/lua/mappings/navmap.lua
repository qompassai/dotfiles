...
function M.setup_navmap()
  ...
  map(
    'n', '<leader>E', '<cmd>Neotree focus<cr>',
    vim.tbl_extend('force', opts, {
      desc = 'Focus Neo-tree'
    }))
  -- Persistence
  ...
  map(
    'n', '<leader>TEI', ':TSNodeIncremental<CR>',
  ...
  map(
    'n', '<leader>TIS', ':TSNodeDecremental<CR>',
    vim.tbl_extend('force',
      opts, {
  ...
  map(
    'n', '<leader>Tss', ':TSScopeIncremental<CR>',
    vim.tbl_extend('force', opts,
      {
  ...
  map(
    'n', '<leader>Tnf', ':TSGotoNextFunction<CR>', vim.tbl_extend('force',
      opts, {
  ...
  map(
    'n', '<leader>TpF', ':TSGotoPreviousFunction<CR>',
    vim.tbl_extend(
