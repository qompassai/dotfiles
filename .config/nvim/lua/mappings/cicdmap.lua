...
function M.setup_cicdmap()
  ...
  vim.api.nvim_create_autocmd('LspAttach', {
    callback = function(ev)
      ...
      map('n', '<leader>zi', '<cmd>:Zi<CR>', vim.tbl_extend('force', opts,
        {
      ...
      map('n', '<leader>zq', ':Z ', vim.tbl_extend('force', opts,
        {
          desc = 'Zoxide query'
        }
      ))
      ...
      map('n', '<leader>zl', '<cmd>:Lz ', vim.tbl_extend('force', opts,
        {
      ...
      -- Zoxide: Local to tab
      map('n', '<leader>zt', '<cmd>:Tz ', vim.tbl_extend('force', opts,
        {
