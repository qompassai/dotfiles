...
class OpsWrapperRelease(Operator):
    ...
    args: StringProperty(name="Keyword Argument", options={"HIDDEN"})
    ...
    def execute(self, context):
        try:
            ...
            if self.args:
                ...
                dic_args = json_loads(self.args)

                e("INVOKE_DEFAULT", **dic_args)  if self.use_invoke is True else e(**dic_args)
            else:
