...
class Admin(Operator):
    ...
    def invoke(self, context, event):
        ...
        global ADMIN, CONTEXT_AREA, CONTEXT_REGION, DRAW_HANDLE, CURSOR_WARP, U_DRAW_CALLBACK_PX, BL_PREF_SYS
        ...
        BL_PREF_SYS = context.preferences.system
        ...
        REGION_DATA.upd(CONTEXT_AREA, CONTEXT_REGION, BL_PREF_SYS.use_region_overlap)
...
class LibraryModifier:
    ...
    def glob_blends(path, recursive, markonly):
        ...
        if P.md_lib_filter:
            ...
            def filter_fx(ob):
                try: return calc_py_exp(lib_filter_text, {'ob': ob})
                except: return False
        else:
...
def late_import_lv2():
    ...
    calc_py_exp = utilbl.pymath.calc_py_exp
