...
class PrefsModifierEditor(PropertyGroup):
    ...
    use_gn_layout: BoolProperty(
        ...
        update = upd_pref,
        options = set())
    style_add_md_menu: EnumProperty(
        name = "Modifier Editor: Add Menu Style",
        description = "Style of add modifier menu",
        items = (
            ("DEFAULT", "Default", ""),
            ("COMPACT", "Compact", "")),
        default = "DEFAULT",
...
class PrefsModalKeymap(PropertyGroup):
    __slots__ = ()

    OpsBlViewRotate: StringProperty(
        name = "view3d.vmd_rotate",
        description = "",
        default = '{\n"cancel": "RIGHTMOUSE",\n"snap": "SPACE",\n"dolly": "MIDDLEMOUSE",\n"forward": "W",\n"backward": "S",\n"left": "A",\n"right": "D",\n"up": "E",\n"down": "Q",\n"fast": "LEFT_SHIFT",\n"slow": "LEFT_CTRL",\n"speed_up": "F",\n"speed_down": "R"\n}',
        options = set())
    OpsBlViewDolly: StringProperty(
        name = "view3d.vmd_dolly",
        description = "",
        default = '{\n"cancel": "MIDDLEMOUSE",\n"pan": "SPACE",\n"fast": "LEFT_SHIFT",\n"slow": "LEFT_CTRL"\n}',
        options = set())
    OpsBlViewZoom: StringProperty(
        name = "view3d.vmd_zoom",
        description = "",
        default = '{\n"cancel": "RIGHTMOUSE",\n"fast": "LEFT_SHIFT",\n"slow": "LEFT_CTRL"\n}',
        options = set())

    def __repr__(self):
        return f'bpy.context.preferences.addons["{__package__}"].preferences.modal_keymaps'
        #|
    #|
    #|
...
class Prefs(bpy.types.AddonPreferences):
    ...
    modal_keymaps: PointerProperty(type = PrefsModalKeymap, name = "Modal Keymaps", options = {"HIDDEN"})
