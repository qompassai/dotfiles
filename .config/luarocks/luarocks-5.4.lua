-- /qompassai/dotfiles/.config/luarocks/luarocks-5.4.lua
-- Qompass AI Luarocks 5.4 Config
...
local lua_root = xdg_data .. '/lua/5.4'
arch = 'x86_64'
...
home = home
lib_modules_dir = 'lib/lua/5.4'
local_by_default = true
lock_manifests = true
lua_interpreter = lua_root .. '/bin/lua'
lua_modules_dir = 'share/lua/5.4'
lua_version = '5.4'
nodeps = false
platform = 'unix'
platforms = {
