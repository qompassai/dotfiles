-- /qompassai/dotfiles/.config/luarocks/luarocks-5.3.lua
-- Qompass AI Luarocks 5.3 Config
...
local lua_root = xdg_data .. '/lua/5.3'
arch = 'x86_64'
...
home = home
lib_modules_dir = 'lib/lua/5.3'
local_by_default = true
lock_manifests = true
lua_interpreter = lua_root .. '/bin/lua'
lua_modules_dir = 'share/lua/5.3'
lua_version = '5.3'
nodeps = false
platform = 'unix'
platforms = {
