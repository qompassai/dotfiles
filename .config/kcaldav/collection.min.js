/*
// /qompassai/dotfiles/.config/kcaldav/collection.min.js
// Qompass AI KCaldav Collection JS Config
...
(function(root) {
	...
	function colnFill(e, p, c)
	{
		...
		for (i = 0, sz = list.length; i < sz; i++) {
			replacen(list[i], location.protocol + '//' + 
				...
				'/cgi-bin/kcaldav/' + p.name + '/' + c.url);
			list[i].href = '/kcaldav/collection.html?id=' + c.id;
		}
	...
	function logout()
	{
		...
		sendQuery('/cgi-bin/kcaldav/logout.json', 
...
(function(root) {
	...
	function loadSuccess(resp)
	{
		...
		if (i === sz) {
			location.href = '/kcaldav/home.html';
			return;
		}
	...
	function load()
	{
		...
		if (null !== (id = getQueryVariable('id')) && 
		    NaN !== parseInt(id))
			sendQuery('/cgi-bin/kcaldav/index.json', 
